...
from advertisements.views import AdvertisementDeleteView, AdvertisementDetailView, AdvertisementUpdateView

urlpatterns = [
    path('advertisements/', AdvertisementDeleteView.as_view(), name='advertisements-list'),
