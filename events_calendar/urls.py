...
from events_calendar.views import EventsListView, EventsDetailView, EventsCreateView, EventsUpdateView, EventsDeleteView

urlpatterns = [
    path('events/', EventsListView.as_view(), name='events-list'),
    path('events/<int:pk>/', EventsDetailView.as_view(), name='event-detail'),
    path('events/create/', EventsCreateView.as_view(), name='events-create'),
